            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <!-- Form -->
                            <form class="js-validate" action="../index.php?act=suatk" method="POST">
                    ...
                    <div class="js-form-message form-group">
                      <input type="text" class="form-control form-control-lg" name="name" placeholder="Họ" aria-label="Williams" required="" data-msg="Please enter your last name.">
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="name" value="" id="signupSrEmail" placeholder="fullname" aria-label="" required="" data-msg="Please enter a valid username.">
                                </div>
                                <!-- Form Group -->
                                <div class="js-form-message form-group">
                  ...
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label text-muted" for="termsCheckbox"> I accept the <a href="#">Terms and Conditions</a></label>
                                ...
                                <!-- End Checkbox -->
                                <input type="text" name="id" value="<?= $id_nd ?>">
                                <input type="submit" class="btn btn-lg btn-block btn-primary mb-2" name="capnhat" value="Cập nhật"></input>
                            </form>
                            <!-- End Form -->
                        </div>
                    </div>
